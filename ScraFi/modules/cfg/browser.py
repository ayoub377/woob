...
class CFGBrowser(SeleniumBrowser):
    BASEURL = 'https://clients.cfgbank.com'
    ...
    login_page = URL(r'/auth/login', LoginPage)
    accounts_page = URL(r'/protected/bin/esp', AccountsPage)
    history_page = URL('', HistoryPage)
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        super(CFGBrowser, self).__init__(*args, **kwargs)
