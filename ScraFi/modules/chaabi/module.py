...
from .browser import ChaabiBrowser


__all__ = ['ChaabiModule']


class ChaabiModule(Module, CapBank):
    NAME = 'chaabi'
    DESCRIPTION = 'Chaabi / banque populaire pro website'
    MAINTAINER = 'Zhor Abid'
    EMAIL = 'zhor.abid@gmail.com'
    LICENSE = 'LGPLv3+'
    VERSION = '3.1'

    BROWSER = ChaabiBrowser
    STORAGE = {'seen': {}}
